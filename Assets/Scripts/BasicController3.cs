...
[System.Serializable]
public class TransformData2
{
    public Vector3 position;
    public Quaternion rotation;
    public Vector3 scale;

    public TransformData2(Vector3 pos, Quaternion rot, Vector3 scl)
    {
        position = pos;
        rotation = rot;
        scale = scl;
...
public class BasicController3 : MonoBehaviour
{
    ...
    private TransformData2 savedTransform;
    ...
    void Start()
    {
        ...
        savedTransform = new TransformData2(
