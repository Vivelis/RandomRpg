...
namespace Linework.Editor.Common
{
    public class CompatibilityCheck : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            window.titleContent = new GUIContent("Linework", EditorGUIUtility.IconContent("Settings").image);
        ...
        private void CreateGUI()
        {
            ...
            var versionLabel = new Label("1.2.3 • November 2024")
            {
                style =
                {
                    fontSize = 12,
        ...
        private CheckResult CheckUnityVersion()
        {
            ...
            return new CheckResult(ResultEnum.Pass, unityVersion, $"Linework is not compatible with Unity {unityVersion}.");
        }
        ...
        private CheckResult CheckTargetPlatform()
        {
            ...
            return target switch
            {
                ...
                BuildTarget.iOS => new CheckResult(ResultEnum.Warning, "iOS", "Linework is compatible with iOS. However, some bugs may still be present. Please reach out if you encounter any issues."),
                BuildTarget.WebGL => new CheckResult(ResultEnum.Warning, "WebGL", "Linework is compatible with WebGL. However, some bugs may still be present. Please reach out if you encounter any issues."),
                _ => new CheckResult(ResultEnum.Fail, target.ToString(), $"Compatibility with {target.ToString()} has not yet been tested. This does not mean that Linework will not work. Please reach out if you encounter any issues.")
            };
        }
        ...
        private CheckResult CheckActiveRenderer()
        {
            ...
            {
                Renderer2DData => new CheckResult(result: ResultEnum.Fail, message: "2D", description: "Linework is not compatible with the 2D Renderer. Support will be added in the future."),
        ...
        private CheckResult CheckRenderingPath()
        {
            ...
            {
                case Renderer2DData:
                    return new CheckResult(result: ResultEnum.Fail, message: "Unknown", description: "Linework is not compatible with the 2D Renderer. Support will be added in the future.");
        ...
        private CheckResult CheckMSAA()
        {
            ...
            return msaaEnabled
                ? new CheckResult(ResultEnum.Fail, "Enabled",
